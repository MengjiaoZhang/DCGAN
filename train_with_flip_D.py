...
def train(netG, netD, optimizerD, optimizerG, dataloader, criterion, num_epochs, device):
    ...
    for epoch in range(num_epochs):
        ...
        p = 'MNIST_DCGAN_results/Random_results/MNIST_DCGAN_with_flip_D_' + str(epoch + 1) + '.png'
        fixed_p = 'MNIST_DCGAN_results/Fixed_results/MNIST_DCGAN_with_flip_D_' + str(epoch + 1) + '.png'
